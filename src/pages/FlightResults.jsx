...
export default function FlightResults() {
    ...
    return (
        <>
            ...
            <div className={`fixed top-0 left-0 h-full max-w-sm z-[9999] transform transition-transform duration-300 ease-in-out ${isFilterOpen ? 'translate-x-0' : '-translate-x-full'}`}>
                <Filters />
            </div>
            ...
            <div className="md:hidden mb-4 flex justify-between items-center">
                <button
                    ...
                    className="px-4 py-2 bg-[#78080B] text-white rounded-full font-medium shadow"
                >
                    Filters
                </button>
            </div>
                                ...
                                <div className="grid grid-cols-4 md:grid-cols-4 gap-3">
                                    {sortOptions.map((option) => (
                                        <div key={option.key} className="relative">
                                            ...
                                            >
                                                <div className="mr-2 sm:mr-4 border border-solid border-[#A8A8A8] bg-[#D9D9D9] p-1 rounded-md flex items-center justify-center">
                                                    <img
                                                        src={option.icon}
                                                        alt={option.label}
                                                ...
                                                <div className="text-start leading-tight">
                                                    <div className="text-[10px] sm:text-base font-medium">
                                                        {option.label}
                                                    </div>
                                                    <div className="text-[7px] sm:text-xs text-gray-700">
                                                        {option.info}
                                                    </div>
                                                </div>
                                    ...
                                    visibleFlights.map((flight) => (
                                        <div key={flight.Flight_Id} className="rounded-2xl">
                                            ...
                                            >
                                                ...
                                                {/* ---- Main Row ---- */}
                                                <div className="py-2 px-3 sm:py-5 flex flex-row md:items-center md:justify-between gap-4 md:gap-6">
                                                    {/* Airline info */}
                                                    <div className="flex items-center space-x-4 justify-start">
                                                        ...
                                                        <div>
                                                            <div className="w-max font-semibold">{flight.Segments[0].Airline_Name}</div>
                                                    ...
                                                    <div className="flex justify-between items-center w-full md:w-auto gap-1 md:gap-6">
                                                        ...
                                                        <div className="text-center min-w-[70px]">
                                                            ...
                                                            <div className="text-[11px] sm:text-xs md:text-sm font-medium text-gray-700">
                                                        ...
                                                        <div className="flex flex-col items-center font-semibold px-2">
                                                            <div className="text-[11px] sm:text-xs md:text-sm font-medium mb-1 text-gray-700">
                                                                {flight.Segments[0].Duration}
                                                            </div>

                                                            <div className="relative w-14 sm:w-16 md:w-24 h-0.5 rounded-xl bg-[#920000]" />

                                                            <div className="text-[11px] sm:text-xs md:text-sm font-medium mt-1 text-gray-700">
                                                        ...
                                                        <div className="flex flex-row md:flex-col items-center md:items-end justify-between md:justify-center gap-1 md:gap-2">
                                                            <div className="text-base sm:text-xl md:text-2xl font-bold text-[#811919]">
                                                                ₹ {flight.Fares[0].FareDetails[0].Total_Amount}
                                                            </div>
                                                            <div className="hidden md:block text-xs font-medium text-gray-600">
                                                                Per Adult
                                                            </div>
                                                        </div>
                                                ...
                                                {/* ---- Mid Bottom Row ---- */}
                                                <div className="flex flex-row md:items-center justify-between text-[11px] sm:text-sm font-medium gap-2">
                                                    ...
                                                    <div className="mr-5 relative rounded-full flex flex-row justify-center items-center">
                                                        <div
                                                        ...
                                                        <div className="flex flex-row" style={{ position: "relative", zIndex: 1 }}>
                                                            ...
                                                            <p className="text-[10px] sm:text-xs">Lock this price starting from ₹ 413</p>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex flex-row justify-between md:flex-row md:items-center text-sm font-medium gap-2">
                                                    <div className="pl-2 md:pl-5 md:pr-55 relative rounded-full flex flex-row justify-center items-center">
                                                        ...
                                                        >
                                                            ...
                                                            <p className="text-[10px] sm:text-xs">FLAT ₹177 OFF using SkyvooSUPER</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="pr-5 flex flex-row justify-between md:justify-start sm:items-center gap-2 sm:gap-0 px-3 py-1 rounded">
                                                        ...
                                                        <button
                                                            className="text-[#811919] cursor-pointer hover:underline text-[11px] sm:text-sm text-left"
