                ...
                <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-15 gap-3 sm:gap-4 lg:gap-6 items-end secondary-font font-semibold">
                    ...
                    {tripType === 'multiCity' ? (
                        ...
                        <>
                            ...
                            {/* Depart */}
                            <div className="col-span-1 sm:col-span-1 lg:col-span-2 relative" ref={departRef}>
                            ...
                            {tripType === 'roundTrip' && (
                                <div className="col-span-1 sm:col-span-1 lg:col-span-2 relative" ref={returnRef}>
